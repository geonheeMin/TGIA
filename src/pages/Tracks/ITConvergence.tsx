...
type ConvergencePramList = {
  Convergence: undefined,
}
type Convergence = NativeStackScreenProps<ConvergencePramList, "Convergence">;

function ITConvergence({navigation, aTrack, bTrack}: Convergence) {
