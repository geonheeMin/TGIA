...
import {Text, View, StyleSheet, SafeAreaView, Image, Pressable, Alert, TouchableOpacity, 
  useWindowDimensions, Animated } from 'react-native';
...
function Profile({navigation, route}:ProfileScreenProps ) {
  ...
  return (
    <SafeAreaView style={styles.safeAreaView}>
      <View style={{flex:0.55, flexDirection: 'row', paddingHorizontal: 10, paddingBottom: -50}}>
      ...
      <View style={{flex:0.35, justifyContent: 'center', paddingHorizontal: 15}}>
